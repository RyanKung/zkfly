...
/// Verifies that the CUDA BN256 MSM provider agrees with the CPU reference.
#[cfg(all(feature = "cuda", target_os = "linux", target_arch = "x86_64"))]
pub fn cuda_msm_self_test() -> bool {
  msm::gpu_msm_self_test()
}

/// Verifies that the CUDA Grumpkin MSM provider agrees with the CPU reference.
#[cfg(all(feature = "cuda", target_os = "linux", target_arch = "x86_64"))]
pub fn cuda_grumpkin_msm_self_test() -> bool {
  msm::gpu_grumpkin_msm_self_test()
}
